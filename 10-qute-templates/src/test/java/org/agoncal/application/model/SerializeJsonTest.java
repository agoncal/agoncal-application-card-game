...
class SerializeJsonTest {
  ...
  private final String jsonOneJack = "{\n" +
    "\"success\": true,\n" +
  ...
  private final String jsonTwoCards = "{\n" +
    "\"success\": true,\n" +
    "\"deck_id\": \"wd8ttfw18vze\",\n" +
    "\"cards\": [\n" +
    "{\n" +
  ...
  public void shouldSerializeTwoCards() {
    ...
    Deck deck = jsonb.fromJson(jsonTwoCards, Deck.class);
  ...
  public void shouldSerializeOneJack() {
    Jsonb jsonb = JsonbBuilder.create();
    Deck deck = jsonb.fromJson(jsonOneJack, Deck.class);
